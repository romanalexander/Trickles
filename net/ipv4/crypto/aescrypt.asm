...
%macro fwd_rnd 1-2 t_fn                ; normal forward rounds
...
%macro inv_rnd 1-2 t_in                ; normal inverse round
...
.3: fwd_rnd r6+ 16          ; 10 rounds for 128-bit key
    ...
    fwd_rnd r6+128
    fwd_rnd r6+144
    fwd_rnd r6+160, t_fl   ; last round uses a different table
...
.3: inv_rnd r6+144          ; 10 rounds for 128-bit key
    ...
    inv_rnd r6+ 32
    inv_rnd r6+ 16
    inv_rnd r6, t_il       ; last round uses a different table
