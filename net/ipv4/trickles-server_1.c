...
# 1 "/usr/lib/gcc-lib/i386-redhat-linux/3.3.4/include/stdarg.h" 1 3 4
# 43 "/usr/lib/gcc-lib/i386-redhat-linux/3.3.4/include/stdarg.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 105 "/usr/lib/gcc-lib/i386-redhat-linux/3.3.4/include/stdarg.h" 3 4
...
# 167 "/home/ashieh/current/include/linux/tcp.h"
enum tcp_ca_state
{
        TCP_CA_Open = 0,
...
# 476 "/home/ashieh/current/include/net/cminisock.h"
struct ucontdesc;
...
# 523 "/home/ashieh/current/include/net/cminisock.h"
...
# 13 "/home/ashieh/current/include/net/trickles_packet.h" 2
...
# 39 "/home/ashieh/current/include/net/trickles_packet.h"
struct PseudoHeader {
  __u32 seq;
  __u8 type;
  __u8 first;
...
# 85 "/home/ashieh/current/include/net/trickles_packet.h"
...
# 212 "/home/ashieh/current/include/net/trickles_packet.h"
...
struct ResponseChunk {
  __u8 type : 4; __u8 flags : 4; __u16 chunkLen;;
    __u8 chunkData[0];
} __attribute__ ((packed));
...
static inline int DataSubchunk_validate(struct ResponseChunk *d) {
        ...
        if (!((c0 = isDataSubchunk(d)))) { printk("KERNEL: assertion (" "(c0 = isDataSubchunk(d))" ") failed at " "/home/ashieh/current/include/net/trickles_packet.h" "(%d)\n", 291); };
        switch(d->type) {
        case RCHUNK_DATA:
                if (!((c1 = !(d->flags & ~0x1)))) { printk("KERNEL: assertion (" "(c1 = !(d->flags & ~DCHUNK_FIN))" ") failed at " "/home/ashieh/current/include/net/trickles_packet.h" "(%d)\n", 294); };
                break;
        case RCHUNK_SKIP:
        case RCHUNK_FINHINT:
                if (!((c1 = (d->flags == 0)))) { printk("KERNEL: assertion (" "(c1 = (d->flags == 0))" ") failed at " "/home/ashieh/current/include/net/trickles_packet.h" "(%d)\n", 298); };
                break;
        }
        return c0&&c1&&c2&&c3;
}
...
# 347 "/home/ashieh/current/include/net/trickles_packet.h"
enum UC_Type {
        UC_INCOMPLETE,
        UC_COMPLETE,
        UC_UPDATE,
...
# 425 "/home/ashieh/current/include/net/trickles_packet.h"
struct SkipCell {
        struct alloc_head *prev;
        struct alloc_head *next;
        struct alloc_head_list *list;
...
# 483 "/home/ashieh/current/include/net/trickles_packet.h"
...
# 547 "/home/ashieh/current/include/net/trickles_packet.h"
...
# 270 "/home/ashieh/current/include/net/sock.h"
struct HMAC_CTX;
...
# 275 "/home/ashieh/current/include/net/sock.h" 2
# 1 "/home/ashieh/current/include/net/trickles_server.h" 1
...
# 276 "/home/ashieh/current/include/net/sock.h" 2
struct tcp_opt {
        int tcp_header_len;
        ...
        __u8 urg_mode;
        __u32 snd_up;
# 435 "/home/ashieh/current/include/net/sock.h"
...
# 1 "/home/ashieh/current/include/net/trickles_sock.inc" 1
        ...
        struct {
                ...
                int D;
                int RTO;
# 75 "/home/ashieh/current/include/net/trickles_sock.inc"
                int timerState;
# 91 "/home/ashieh/current/include/net/trickles_sock.inc"
                int rcv_nxt;
                int previous_base;
...
# 109 "/home/ashieh/current/include/net/trickles_sock.inc"
                int ack_last;
...
# 140 "/home/ashieh/current/include/net/trickles_sock.inc"
...
# 486 "/home/ashieh/current/include/net/sock.h" 2
};
# 542 "/home/ashieh/current/include/net/sock.h"
typedef struct {
        spinlock_t slock;
        unsigned int users;
...
# 656 "/home/ashieh/current/include/net/sock.h"
        } tp_pinfo;
...
# 684 "/home/ashieh/current/include/net/sock.h"
        union {
                void *destruct_hook;
...
# 717 "/home/ashieh/current/include/net/sock.h"
                struct netlink_opt *af_netlink;
# 730 "/home/ashieh/current/include/net/sock.h"
        } protinfo;
...
# 770 "/home/ashieh/current/include/net/sock.h"
struct proto {
...
# 854 "/home/ashieh/current/include/net/sock.h"
extern void __lock_sock(struct sock *sk);
extern void __release_sock(struct sock *sk);
# 877 "/home/ashieh/current/include/net/sock.h"
...
# 977 "/home/ashieh/current/include/net/sock.h"
...
# 1011 "/home/ashieh/current/include/net/sock.h"
...
# 1067 "/home/ashieh/current/include/net/sock.h"
...
# 1094 "/home/ashieh/current/include/net/sock.h"
...
# 1223 "/home/ashieh/current/include/net/sock.h"
...
# 1397 "/home/ashieh/current/include/net/sock.h"
...
# 1102 "/home/ashieh/current/include/net/tcp.h"
...
# 1103 "/home/ashieh/current/include/net/tcp.h" 2
...
# 1133 "/home/ashieh/current/include/net/tcp.h"
...
# 1241 "/home/ashieh/current/include/net/tcp.h"
static __inline__ int
...
{
# 1282 "/home/ashieh/current/include/net/tcp.h"
...
# 1388 "/home/ashieh/current/include/net/tcp.h"
...
# 1428 "/home/ashieh/current/include/net/tcp.h"
...
{
# 1532 "/home/ashieh/current/include/net/tcp.h"
...
# 1556 "/home/ashieh/current/include/net/tcp.h"
...
static inline int tcp_paws_check(struct tcp_opt *tp, int rst)
{
        ...
        if (xtime.tv_sec >= tp->ts_recent_stamp + (60 * 60 * 24 * 24))
                return 0;
# 1894 "/home/ashieh/current/include/net/tcp.h"
...
# 1947 "/home/ashieh/current/include/net/tcp.h"
...
# 249 "/home/ashieh/current/include/net/trickles.h"
...
# 262 "/home/ashieh/current/include/net/trickles.h"
...
# 364 "/home/ashieh/current/include/net/trickles.h"
...
# 53 "/home/ashieh/current/include/net/trickles_client.h"
...
struct Request {
# 168 "/home/ashieh/current/include/net/trickles_client.h"
        struct alloc_head *prev; struct alloc_head *next; struct alloc_head_list *list; enum UserRequestType type; unsigned numChildren; unsigned numActualChildren; unsigned childrenMask : 4; struct { __u32 start, end; } childRanges[4]; unsigned transport_seq; unsigned seq; unsigned start, end; unsigned isNew : 1; unsigned allocated : 1; unsigned transportResponseSeqStart, transportResponseSeqEnd;
};
...
# 35 "/home/ashieh/current/include/net/trickles_state_cache.h"
...
struct sk_buff;
# 266 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
...
# 308 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
...
static inline struct cminisock *copyClientSide_Continuation(struct cminisock *cont, int flags) {
  ...
  struct cminisock *rval = kmem_cache_alloc(clientSideContinuation_cache, (0x20));
# 411 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  if(rval == ((void *)0)) {
  ...
  for(i=0; i < 2; i++) {
# 429 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
          (rval+i)->ucont_len = 0;
          (rval+i)->ucont_data = ((void *)0);
...
# 463 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  int i;
# 483 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  if(cont->list) {
          do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
  }
...
# 508 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
...
void SkipCell_free(struct SkipCell *cell) {
 ...
 static int SkipCell_intersectRange(struct SkipCell *c0, unsigned start, unsigned end) {
        unsigned left = ({ typeof(c0->start) Z = (typeof(c0->start))(start); ({ const typeof(c0->start) _x = (c0->start); const typeof(Z) _y = (Z); (void) (&_x == &_y); _x > _y ? _x : _y; }); });
        unsigned right = ({ typeof(c0->end) Z = (typeof(c0->end))(end); ({ const typeof(c0->end) _x = (c0->end); const typeof(Z) _y = (Z); (void) (&_x == &_y); _x < _y ? _x : _y; }); });
        return left < right;
 }
...
static int SkipCell_insert(struct sock *sk, struct SkipCell *cell) {
        ...
        if(empty(list)) {
                ...
                if(cell->end <= next->start) {
                        if (!((struct alloc_head_list *)prev == list)) { printk("KERNEL: assertion (" "(struct alloc_head_list *)prev == list" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 564); };

                        found = 1;
                } else {
                        for (next = (typeof(next))(list)->next; (next != (typeof(next))(list)); next=(typeof(next))next->next) {
                ...
                if((struct alloc_head_list*)next == list) {
                        if(prev->end <= cell->start) {
                                if(found) do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
...
# 616 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
                ...
                if (!(!found)) { printk("KERNEL: assertion (" "!found" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 623); };
                do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
                return 0;
        }
}
...
UC_Continuation_receivedFIN(struct UC_Continuation *cont, unsigned finPosition) {
        ...
        if (!(finPosition <= cont->kernel.obsoleteAt)) { printk("KERNEL: assertion (" "finPosition <= cont->kernel.obsoleteAt" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 674); };
...
static unsigned UC_Continuation_virtualEnd(struct UC_Continuation *cont) {
        if(cont->FINHint) {
                if (!(cont->FINHintPosition <= cont->validEnd)) { printk("KERNEL: assertion (" "cont->FINHintPosition <= cont->validEnd" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 696); };
...
UC_Continuation_inSkippedRegion(struct UC_Continuation *cont, unsigned position) {
        if (!(cont->validStart <= position && position < cont->validEnd)) { printk("KERNEL: assertion (" "cont->validStart <= position && position < cont->validEnd" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 713); };
...
# 779 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
...
# 797 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  printk("Dependency management doesn't work yet\n");
  do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
  return -1;
...
# 826 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  printk("Dependency management doesn't work yet\n");
  do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
  return ((void *)0);
...
# 843 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  printk("Dependency management doesn't work yet\n");
  do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
...
# 871 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
  printk("Dependency management doesn't work yet\n");
  do { if (!(0)) { printk("kgdb assertion failed: %s\n", "BUG"); show_stack(((void *)0)); breakpoint(); } } while (0);
  return -1;
...
int GenerateDataContext_packetSpace(struct GenerateDataContext *ctx) {
        ...
        return ((ctx)->packets[(ctx)->packetNum].len - (ctx)->packets[(ctx)->packetNum].ucontLen) - ctx->packetPos;
}

static inline
char *GenerateDataContext_put(struct GenerateDataContext *ctx, int numBytes) {
# 1060 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
        ...
        if(GenerateDataContext_packetSpace(ctx) >= numBytes) {
                ...
                ctx->outputPos += ((ctx)->packets[(ctx)->packetNum].len - (ctx)->packets[(ctx)->packetNum].ucontLen) - ctx->packetPos;
                ctx->packetPos = 0;
                ctx->packetNum++;
        }
        temp = ctx->outputPos;
        ...
        if (!(ctx->packetPos <= ((ctx)->packets[(ctx)->packetNum].len - (ctx)->packets[(ctx)->packetNum].ucontLen))) { printk("KERNEL: assertion (" "ctx->packetPos <= PACKET_LEN(ctx)" ") failed at " "/home/ashieh/current/include/net/trickles_packet_helpers.h" "(%d)\n", 1085); };

        if(ctx->packetPos == ((ctx)->packets[(ctx)->packetNum].len - (ctx)->packets[(ctx)->packetNum].ucontLen)) {
                ctx->packetPos = 0;
                ctx->packetNum++;
        }
        return temp;
...
# 1219 "/home/ashieh/current/include/net/trickles_packet_helpers.h"
}
...
# 327 "/home/ashieh/current/include/net/trickles_client.h" 2
...
# 371 "/home/ashieh/current/include/net/trickles.h" 2
# 381 "/home/ashieh/current/include/net/trickles.h"
...
# 430 "/home/ashieh/current/include/net/trickles.h"
        tp->t.ack_last = 0;
        tp->t.oo_count = 0;
        tp->t.in_flight = 0;
...
struct trickles_mmap_ctl {
# 65 "/home/ashieh/current/include/net/trickles_userapi.h"
        void *rw_base;
        int rw_offs;
        __u32 rw_len;
...
# 101 "/home/ashieh/current/include/net/trickles_userapi.h"
...
# 500 "/home/ashieh/current/include/net/trickles.h" 2
...
# 503 "/home/ashieh/current/include/net/trickles.h" 2
...
# 505 "/home/ashieh/current/include/net/trickles.h" 2
# 7 "trickles-int.h" 2
...
WireTrickleRequest *WireTrickleRequest_extract(struct sock *serverSK, struct sk_buff *skb, struct cminisock **pmsk, int *error) {
        ...
        struct cminisock *msk = ({ struct cminisock *__msk = &cpu_msk[0]; msk_initStatic(__msk); __msk; });
...
# 574 "trickles-server.c"
        ...
        lookup_failed:
                ;
                if(!(((serverSK)->tp_pinfo.af_tcp.trickles_opt & 0x1) && !((serverSK)->tp_pinfo.af_tcp.trickles_opt & (serverSK)->tp_pinfo.af_tcp.trickles_opt & 0x8))) {
                        msk = ({ struct cminisock *__msk = &cpu_msk[0]; msk_initStatic(__msk); __msk; });
                } else {
...
int server_rcv_impl(struct sock *sk, struct sk_buff *in_skb) {
        ...
        if(!(((sk)->tp_pinfo.af_tcp.trickles_opt & 0x1) && !((sk)->tp_pinfo.af_tcp.trickles_opt & (sk)->tp_pinfo.af_tcp.trickles_opt & 0x8)) && !((tp)->cminisock_api_config.cfg.mmap_base != ((void *)0) && (tp)->cminisock_api_config.cfg.ctl != ((void *)0))) {
                printk("Not configured\n");
                goto out;
        }
# 803 "trickles-server.c"
        ;
        if((((sk)->tp_pinfo.af_tcp.trickles_opt & 0x1) && !((sk)->tp_pinfo.af_tcp.trickles_opt & (sk)->tp_pinfo.af_tcp.trickles_opt & 0x8))) {
                goto normal;
        }
        if(ith->syn) {
                if((((sk)->tp_pinfo.af_tcp.trickles_opt & 0x1) && !((sk)->tp_pinfo.af_tcp.trickles_opt & (sk)->tp_pinfo.af_tcp.trickles_opt & 0x8))) { msk = alloc_trickles_msk(sk); } else { msk = ({ struct cminisock *__msk = &cpu_msk[0]; msk_initStatic(__msk); __msk; }); } msk->serverSK = sk; msk->sk = sk; in_skb->sk = sk; pre_init_sock(msk,in_skb);;
                __u32 firstSeq;
...
# 1251 "trickles-server.c"
                        if(sysctl_trickles_Continuation_enable) {
                                if(((msk->pmsk)->cacheRecycleIndex >= 0)) {
                                        ...
                                        if (!(packet_num == msk->pmsk->cacheRecycleIndex)) { printk("KERNEL: assertion (" "packet_num == msk->pmsk->cacheRecycleIndex" ") failed at " "trickles-server.c" "(%d)\n", 1258); };
                                }
                        }
                        break;
                default:
        ...
        *(__u32*)(th+1) = htonl((11 << 24) |
        ...
        if (!(sk->protocol == IPPROTO_TCP)) { printk("KERNEL: assertion (" "sk->protocol == IPPROTO_TCP" ") failed at " "trickles-server.c" "(%d)\n", 1350); };
...
# 1381 "trickles-server.c"
void NormalizeContinuation(struct cminisock *cont, AckProof *ackProof) {
# 1402 "trickles-server.c"
}
# 1458 "trickles-server.c"
static int DoNormalStep(struct cminisock **cont,
  ...
  for(i=0; i < numOutput; i++) {
    ...
    contType = (((offset) < (7)) ? (1) : ((((offset)) % 2 == 0) ? (2) : (0)));
# 1579 "trickles-server.c"
    switch(contType) {
    case (1):
    case (2):
...
static int DoRecoveryStep(struct cminisock **cont, AckProof *ackProof,
  ...
  switch(((((*cont)->firstLoss - (*cont)->TCPBase) < (7)) ? (1) : (((((*cont)->firstLoss - (*cont)->TCPBase)) % 2 == 0) ? (2) : (0)))) {
  case (1):
  case (0):
