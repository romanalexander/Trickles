 ...
 *
 *	$Id: br_private.h,v 1.2 2004/07/19 20:42:05 ashieh Exp $
 *
...
extern struct alloc_head_list bridgeLogHead;
...
struct BridgeLogEntry {
	struct BridgeLogEntry *prev;
	struct BridgeLogEntry *next;
	struct alloc_head_list *list;
...
extern void br_log_impl(__u32 saddr, __u32 daddr, __u16 source, __u16 dest, 
			__u32 seq, __u32 ack_seq);

//#define LOG_BRIDGE_PACKETS
