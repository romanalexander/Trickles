...
enum
{
	...
	NET_TRICKLES_MSS=999,

	NET_TRICKLES_Continuation_ENABLE=1000,
	NET_TRICKLES_Continuation_POLICY=1001,
	NET_TRICKLES_Continuation_HITS=1002,
	NET_TRICKLES_Continuation_TOTAL=1003,

	NET_TRICKLES_Nonce_ENABLE=1004,
	NET_TRICKLES_Nonce_POLICY=1005,
	NET_TRICKLES_Nonce_HITS=1006,
	NET_TRICKLES_Nonce_TOTAL=1007,

	NET_TRICKLES_TCB_ENABLE=1008,
	NET_TRICKLES_TCB_POLICY=1009,
	NET_TRICKLES_TCB_HITS=1010,
	NET_TRICKLES_TCB_TOTAL=1011,

	NET_TRICKLES_HASHCOMPRESS=1012,
};
