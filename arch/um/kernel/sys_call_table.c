...
extern syscall_handler_t sys_trickles_send;
extern syscall_handler_t sys_trickles_sendv;
extern syscall_handler_t sys_trickles_sendfilev;
extern syscall_handler_t sys_trickles_setucont;
extern syscall_handler_t sys_trickles_sendbulk;
extern syscall_handler_t sys_trickles_extract_events;
extern syscall_handler_t sys_trickles_install_events;

//#define LAST_GENERIC_SYSCALL __NR_exit_group
#define LAST_GENERIC_SYSCALL __NR_cminisock_install_events
...
syscall_handler_t *sys_call_table[] = {
	...
	[ __NR_cminisock_send ] = sys_trickles_send,
	[ __NR_cminisock_sendv ] = sys_trickles_sendv,
	[ __NR_cminisock_sendfilev ] = sys_trickles_sendfilev,
	[ __NR_cminisock_setucont ] = sys_trickles_setucont,
	[ __NR_cminisock_sendbulk ] = sys_trickles_sendbulk,
	[ __NR_cminisock_extract_events ] = sys_trickles_extract_events,
	[ __NR_cminisock_install_events ] = sys_trickles_install_events,
